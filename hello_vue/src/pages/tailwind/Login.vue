        ...
        <div class="w-full max-w-xs">
            ...
            <div class="bg-white border p-8 shadow rounded w-full mb-6">
                ...
                <form method="POST" action="/login">
                    ...
                    <fieldset class="mb-4">
                        <label for="email" class="block text-sm text-gray-900 mb-2">Email address</label>
                        <input id="email" type="email" class="block w-full rounded-sm border bg-white py-2 px-3 text-sm"
                    ...
                    <fieldset class="mb-4">
                        ...
                        <input id="password" type="password"
                            class="block w-full rounded-sm border bg-white py-2 px-3 text-sm" name="password" required>
                    </fieldset>
            ...
            <p class="text-center text-sm text-gray-600 font-thin">Don't have an account yet? <a href="/register"
                    class="text-blue-500 no-underline hover:underline">Sign up</a></p>
        </div>
